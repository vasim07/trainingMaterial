---
title: "Functions, R Markdown & Static Dashboard"
subtitle: "Rave Tech"
author: "Vasim Shaikh"
date: "2017/09/20"
output:
  xaringan::moon_reader:
    chakra: C:/Users/vasim.shaikh/Documents/libs/remark-latest.min.js
    nature:
...
```{r, helloworld, eval=FALSE, tidy=FALSE}
...
# *When code is copied pasted more than twice*.
---
...
--
1) Eliminate mistakes while copy pasting   
2) Update code at one place instead of many  
3) Code easiear to understand  
...
# What is RMarkdown and why should we learn it?

---
# Understanding R Markdown cheat sheet
